...
interface RegistrarPrejuizoModalProps {
  aberto: boolean;
  onClose: () => void;
}


export function RegistrarPrejuizoModal({ aberto, onClose }: RegistrarPrejuizoModalProps) {
    ...
    <Dialog open={aberto} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader className="pb-4">
          <DialogTitle className="text-red-500 text-xl font-bold text-center">
            Registrar Prejuízo
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6 px-1">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Ex: Aquisição de Freebet"
              className="h-11"
            />
          </div>
          ...
          <div className="flex gap-3 pt-6">
            ...
            <Button
              ...
              disabled={salvando}
            >
              {salvando ? 'Salvando...' : 'Salvar Prejuízo'}
            </Button>
          </div>
        </div>
      </DialogContent>
